...
namespace MedicalSys.Framework
{
    ...
    public class MSFileAppender : TextWriterAppender
    {
        ...
        {
            private MSFileAppender m_appender = null;
            ...
            /// </para>
            /// </remarks>
            public MSFileAppender CurrentAppender
            {
        ...
        public MSFileAppender(ILayout layout, string filename, bool append)
        {
            Layout = layout;
            File = filename;
            AppendToFile = append;
        ...
        public MSFileAppender(ILayout layout, string filename)
        ...
        virtual public string File
        {
            get
            {
                //string data = DateTime.Now.ToString("_yyyy-MM-dd");
                //string filename = string.Empty;
                //if(m_fileName.EndsWith(".log", true, CultureInfo.CurrentCulture))
                //{
                //    filename = m_fileName.Substring(0, m_fileName.Length - 4) + data + ".log";
                //}else
                //{
                //    filename = m_fileName + data;
                //}

                //return filename;
                GetBaseFileWithoutDatatime(m_fileName);
                return m_fileName;
            }
            set
            {
                GetBaseFileWithoutDatatime(value);
            }
        }

        private void GetBaseFileWithoutDatatime(string file)
        {
            ...
            string data = file.Substring(file.Length - 14, 10);
            DateTime temp;
            if (DateTime.TryParse(data, out temp))
            {
                m_fileName = file.Substring(0, file.Length - 15) + DateTime.Now.ToString("_yyyy-MM-dd") + ".log";

                if (!temp.ToString("yyyy-MM-dd").Equals(DateTime.Now.ToString("yyyy-MM-dd")))
                {
                    ActivateOptions();
                }
            }
            ...
            {
                m_fileName = file.Substring(0, file.Length - 4) + DateTime.Now.ToString("_yyyy-MM-dd") + ".log";
            }
        }
        ...
        /// </para>
        /// </remarks>
        public MSFileAppender.LockingModelBase LockingModel
        {
        ...
        override public void ActivateOptions()
        {
            ...
            {
                m_lockingModel = new MSFileAppender.ExclusiveLock();
            }
        ...
        /// </summary>
        private MSFileAppender.LockingStream m_stream = null;

        /// <summary>
        /// The locking model to use
        /// </summary>
        private MSFileAppender.LockingModelBase m_lockingModel = new MSFileAppender.ExclusiveLock();
